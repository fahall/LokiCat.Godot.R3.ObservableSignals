...
""");
            ...
            foreach (var field in group)
            {
                ...
                var signalName = baseName; // Godot signal emitted: Jump
                var delegateName = $"{baseName}EventHandler"; // Godot delegate: JumpEventHandler
                var propertyName = $"On{baseName}"; // Exposed observable property: OnJump
